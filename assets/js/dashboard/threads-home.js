$(document).ready(function () {
    ...
    $("#connectThreadsButton").on("click", function () {
        ...
        const threadsAuthUrl = 'https://threads.net/oauth/authorize?client_id=1023999582681781&redirect_uri=https://thriendly.com/threads/auth&scope=threads_basic,threads_content_publish&response_type=code&state=' + state;
