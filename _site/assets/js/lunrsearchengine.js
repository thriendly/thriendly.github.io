...
var documents = [{
    ...
    "body": "      Thriendly: AI Replys:                                                                       Total Credits:                                                                                                                                                                                               Your Account Key                                                                                                            Copy                                                                                                        Generate Key                                    Error fetching data. Please                    try again in sometime !                                                                                                                                                                                                                To Use Thriendly AI Replys for Threads / X:                                   Install our Thriendly chrome extension to create  AI Reply  button under                    threads post.                    Install                    Chrome Extension                  Once you install, Enter the account key above (You can click                     Generate Key  above if its empty) in the Chrome                    extension that                    you installed                                Note: Each AI Reply consumes 1 credit.                                                                                                                                                     "
    }, {
    "id": 3,
