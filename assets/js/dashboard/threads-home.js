...
//             const profileAPI = "https://scheduler-dev.pramodnanduri.workers.dev/threads/profile"; // Adjust the URL as needed
...
$(document).ready(function () {
    ...
    checkAuthAndExecute((user) => {
        user.getIdToken().then((token) => {
            ...
            const userAPI = "https://scheduler-dev.pramodnanduri.workers.dev/users"; // Adjust the URL as needed
